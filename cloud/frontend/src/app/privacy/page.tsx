...
function PrivacyContentEn() {
  return (
    <>
      ...
      <ul>
        <li>The Service runs in local mode with a single built-in local user (no signup or login)</li>
      ...
      <ul>
        <li><strong>Database:</strong> Local SQLite by default (or your own PostgreSQL if configured)</li>
      ...
      <h2>8. Cookies</h2>
      <p>
        The Service runs in local mode and does not require authentication cookies or sessions.
